								 ...
								 int roi_bottom_right_u, int roi_bottom_right_v)
{
  ...
  detector->classifier = new fern_based_point_classifier(detector->number_of_model_points,
							 number_of_ferns, number_of_tests_per_fern,
								      ...
								      double minimum_number_of_views_rate)
{
  ...
  if (point_detector == 0) 
      detector->point_detector = new pyr_yape06(); 
  point_detector = detector->point_detector;
